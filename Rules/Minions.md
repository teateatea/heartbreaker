...
- Minions may make a group attack: $M$ minions make one attack with a +$M$ bonus, then deal their damage $\times$  $M$. *(4 goblin minions roll 1d20 + 4 to hit, then deal 1 $\times$ 4 damage.)*
- Minions may make group saves: All minions in the group take the same result.
___
# Minions
